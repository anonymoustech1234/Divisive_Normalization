...
def modify_cifar100(model: nn.Module, args_model: dict) -> nn.Module:
    # UNTEST
    # changing the alexnet to fit for the cifar100

    if args_model['for_dataset'] == 'cifar100' or args_model['for_dataset'] == 'cifar10':
        model.features.conv1 = nn.Conv2d(in_channels=3, out_channels=64, kernel_size=3, stride=1,padding=1)
        model.features.conv2 = nn.Conv2d(64, 192, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
